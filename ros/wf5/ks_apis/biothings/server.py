...
class WF1Mod2And3(Resource):
    """Translator WF1Mod2And3. """
    ...
    def post(self):
        ...
        if obj:
            ...
            knowledge_graph = self.workflow_1_modules_1_and_2 (request.json['knowledge_graph']['nodes'])
        '''
...
api.add_resource(WF1Mod2And3, '/wf1mod2and3')
